 ...
 */
public class NationalFootballLeague implements Tournament {
    ...
    public NationalFootballLeague(String type, String name, int quantityOfStaff, int year, List<Team> teams, List<String> equipmentList, List<String> leaderboard, List<Integer> listOfQuantities) {
        type_ = type;
        name_ = name;
